    ...
    <React.Fragment>
      <Row className="mt-4 pt-4 mb-4 homepagesponsored-headlines with-changed-view">
        ...
        <Col lg={4} xs={12} className="col-gap" style={{ padding: "30px" }}>
          <div className="gap-space"></div>
          <Card border="light" className="shadow-sm  custom-card">
            <img src={TownCom} alt="veribox"></img>
            <img src={VERI_COM} alt="veri_com"></img>
            <div className="veribox">
              Battery-powered solution for remote<br /> reading of household meters via mesh<br /> network technology.<br />
              Each radio node in the system is<br /> automatically a repeater/router for the<br /> other radio nodes in the same network.
            </div>
          </Card>
        </Col>
      </Row>
